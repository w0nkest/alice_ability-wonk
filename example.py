...
cities = {
    'москва': ['1533899/e6d83d322fd22c8ba5a4'],
    'нью-йорк': ['1652229/41e9836665260752f4fe'],
    'париж': ["1521359/dc07f566206e741fdfce"]
}
...
def play_game(res, req):
    ...
    if 'помощ' in req['request']['nlu']['tokens']:
        res['response']['text'] = 'Короче, все легко: Я показываю город - ты говоришь че за город.'
    else:
        if attempt == 1:
